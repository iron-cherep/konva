...
Factory_1.Factory.addGetterSetter(Text, 'textUnderlineOffset', 0);
Factory_1.Factory.addGetterSetter(Text, 'textDecorationColor');
Factory_1.Factory.addGetterSetter(Text, 'textDecorationThickness');
